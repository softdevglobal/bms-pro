...
export default function BookingsConfirmed() {
  ...
  const handleExport = useCallback(async () => {
    ...
    const rows = dataToExport.map((booking) => ({
      ...
      'Total Value': `$${(booking.totalValue * 1.1).toLocaleString('en-AU', { minimumFractionDigits: 2 })} (incl. GST)`,
      'Balance': `$${(booking.balance * 1.1).toLocaleString('en-AU', { minimumFractionDigits: 2 })} (incl. GST)`,
